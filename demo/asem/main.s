...
.L32:
	...
	test	rax, rax
	jne	.L33
	.loc 1 158 3 discriminator 2
	lea	rdi, .LC22[rip]
	call	puts@PLT
	.loc 1 159 3 discriminator 2
	lea	rdi, .LC23[rip]
	call	puts@PLT
	.loc 1 160 3 discriminator 2
	lea	rdi, .LC24[rip]
	call	puts@PLT
