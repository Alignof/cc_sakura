...
.LFB10:
	...
	test	eax, eax
	je	.L100
	.loc 1 336 31 discriminator 1
	mov	rax, QWORD PTR token[rip]
	mov	edx, DWORD PTR -16[rbp]
	mov	esi, edx
	mov	rdi, rax
	call	find_defined_type@PLT
	.loc 1 336 28 discriminator 1
	test	rax, rax
	je	.L101
.L100:
.LBB13:
...
.LFB11:
	...
	test	al, al
	je	.L114
	.loc 1 390 36 discriminator 1
	mov	rax, QWORD PTR token[rip]
	.loc 1 390 22 discriminator 1
	mov	rax, QWORD PTR 24[rax]
	lea	rsi, .LC39[rip]
	mov	rdi, rax
	call	error_at@PLT
...
.L119:
	...
	je	.L120
	.loc 1 460 44 is_stmt 0 discriminator 1
	mov	rax, QWORD PTR -24[rbp]
	mov	rax, QWORD PTR 16[rax]
	jmp	.L121
.L120:
	.loc 1 460 44 discriminator 2
	mov	rax, QWORD PTR labels_head[rip]
.L121:
	.loc 1 460 10 is_stmt 1 discriminator 4
	mov	QWORD PTR -40[rbp], rax
	.loc 1 461 8 discriminator 4
	jmp	.L122
.L128:
	.loc 1 462 9
	mov	rax, QWORD PTR -40[rbp]
...
.L136:
	...
	jmp	.L140
.L141:
	.loc 1 592 37 discriminator 2
	mov	rax, QWORD PTR token[rip]
	mov	rdx, QWORD PTR 24[rax]
	.loc 1 592 43 discriminator 2
	sub	rdx, 1
	mov	QWORD PTR 24[rax], rdx
.L140:
	...
	mov	rax, QWORD PTR token[rip]
	mov	rax, QWORD PTR 24[rax]
	.loc 1 592 10 discriminator 1
	movzx	eax, BYTE PTR [rax]
	.loc 1 592 9 discriminator 1
	cmp	al, 10
	jne	.L141
	.loc 1 593 18
	mov	rax, QWORD PTR token[rip]
...
.L154:
	...
	cmp	eax, 2
	jne	.L155
	.loc 1 693 49 discriminator 1
	mov	rax, QWORD PTR token[rip]
	mov	rax, QWORD PTR 24[rax]
	.loc 1 693 43 discriminator 1
	movzx	eax, BYTE PTR [rax]
	.loc 1 693 34 discriminator 1
	movsx	eax, al
	mov	edi, eax
	call	is_alnum@PLT
	.loc 1 693 32 discriminator 1
	xor	eax, 1
	.loc 1 693 30 discriminator 1
	test	al, al
	je	.L156
.L155:
	.loc 1 694 18
