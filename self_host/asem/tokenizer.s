...
.LFB0:
	...
	cmp	al, 123
	je	.L2
	.loc 1 4 27 discriminator 2
	mov	rax, QWORD PTR -8[rbp]
	movzx	eax, BYTE PTR [rax]
	.loc 1 4 23 discriminator 2
	cmp	al, 125
	jne	.L3
.L2:
	.loc 1 4 23 is_stmt 0 discriminator 3
	mov	eax, 1
	jmp	.L4
.L3:
	.loc 1 4 23 discriminator 4
	mov	eax, 0
.L4:
	.loc 1 4 23 discriminator 6
	and	eax, 1
	.loc 1 5 1 is_stmt 1 discriminator 6
	pop	rbp
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB2:
	...
	je	.L9
	.loc 1 12 33 discriminator 4
	cmp	BYTE PTR -4[rbp], 32
	jne	.L10
.L9:
	.loc 1 12 33 is_stmt 0 discriminator 5
	mov	eax, 1
	jmp	.L11
.L10:
	.loc 1 12 33 discriminator 6
	mov	eax, 0
.L11:
	.loc 1 12 33 discriminator 8
	and	eax, 1
	.loc 1 13 1 is_stmt 1 discriminator 8
	pop	rbp
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB3:
	...
	jle	.L14
	.loc 1 16 23 is_stmt 0 discriminator 1
	...
	jmp	.L15
.L14:
	.loc 1 16 23 discriminator 4
	mov	eax, 0
.L15:
	.loc 1 16 23 discriminator 6
	and	eax, 1
	.loc 1 17 1 is_stmt 1 discriminator 6
	pop	rbp
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.L21:
	...
	jne	.L22
.L19:
	.loc 1 22 32 is_stmt 0 discriminator 3
	mov	eax, 1
	jmp	.L23
.L22:
	.loc 1 22 32 discriminator 4
	mov	eax, 0
.L23:
	.loc 1 22 32 discriminator 6
	and	eax, 1
	.loc 1 24 1 is_stmt 1 discriminator 6
	pop	rbp
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.L36:
	...
	mov	rax, QWORD PTR -72[rbp]
	add	rax, 1
	.loc 1 55 34 discriminator 1
	movzx	edx, BYTE PTR [rax]
	.loc 1 55 59 discriminator 1
	mov	eax, DWORD PTR -4[rbp]
	cdqe
	movzx	eax, BYTE PTR -39[rbp+rax]
	...
	jmp	.L43
.L35:
	.loc 1 54 22 discriminator 2
	add	DWORD PTR -4[rbp], 1
.L34:
	.loc 1 54 2 discriminator 1
	mov	eax, DWORD PTR -4[rbp]
	cmp	eax, DWORD PTR -8[rbp]
	jl	.L36
	.loc 1 62 7
...
.L39:
	...
	cmp	dl, al
	jne	.L38
	.loc 1 64 38 discriminator 1
	mov	rax, QWORD PTR -72[rbp]
	add	rax, 1
	.loc 1 64 33 discriminator 1
	movzx	edx, BYTE PTR [rax]
	.loc 1 64 59 discriminator 1
	mov	eax, DWORD PTR -4[rbp]
	add	eax, 1
...
.LFB8:
	...
	test	eax, eax
	jne	.L47
	.loc 1 93 46 discriminator 1
	mov	rax, QWORD PTR -8[rbp]
	mov	rdx, QWORD PTR [rax]
	.loc 1 93 49 discriminator 1
	mov	eax, DWORD PTR -20[rbp]
	cdqe
	add	rax, rdx
	movzx	eax, BYTE PTR [rax]
	.loc 1 93 36 discriminator 1
	movsx	eax, al
	mov	edi, eax
	call	is_alnum
